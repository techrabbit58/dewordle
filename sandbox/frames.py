...
disable_size_changes = dict(width=False, height=False)


def create_input_frame(container: tk.Tk) -> ttk.Frame:
    ...
    wrap_around_check = ttk.Checkbutton(
        ...
        text='Wrap around'.title(),
        command=lambda: wrap_around.get())
...
def create_main_window() -> None:
    ...
    root.title('Replace')
    root.resizable(**disable_size_changes)
    ...
    button_frame.grid(column=1, row=0, padx=5, pady=5)
